...
#agregar un contador de vidas para cada vez que choques con un obj malo pierdas una y si tenes puntaje negativo perdes
    
#si tenes puntaje negativo termina el juego
    
# cada vez que tenes mas puntos aumenta la velocidad de los objetos 